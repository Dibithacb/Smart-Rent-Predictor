...
import { FaBed, FaBath, FaRulerCombined, FaStar, FaHeart, FaShareAlt, FaChartLine, FaMapMarkerAlt, FaPhone, FaEnvelope, FaArrowLeft } from 'react-icons/fa'
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <div className="flex items-center text-gray-600">
                ...
                <span className="text-lg">{property.location.area}, {property.location.emirate}</span>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg mb-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                ...
                <div className={`inline-flex items-center px-4 py-2 rounded-full ${getPriceTrendColor()}`}>
                  <FaChartLine className="mr-2" />
                  <span className="font-semibold">
                    {getPriceTrendIcon()} Predicted: AED {property.predictedPrice?.toLocaleString() || 'N/A'}
                  </span>
                </div>
              </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="border-b">
                <nav className="flex">
                  {['overview', 'amenities', 'neighborhood', 'price-trend'].map((tab) => (
                    <button
                      key={tab}
              ...
              <div className="p-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="text-2xl font-bold">{property.rating}/5</div>
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      {property.amenities.map((amenity, index) => (
                        <div key={index} className="flex items-center p-3 bg-gray-50 rounded-lg">
                          ...
                          <span className="font-medium">{amenity.charAt(0).toUpperCase() + amenity.slice(1)}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {activeTab === 'neighborhood' && (
                  <div>
                    <h3 className="text-xl font-bold mb-4">Neighborhood Insights</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-blue-50 p-6 rounded-xl">
                        <h4 className="font-bold text-lg mb-4">Area Highlights</h4>
                ...
                {activeTab === 'price-trend' && (
                  <div>
                    <h3 className="text-xl font-bold mb-4">AI Rent Prediction Analysis</h3>
                    <div className="bg-linear-to-r from-blue-50 to-indigo-50 p-6 rounded-xl">
                      <div className="text-center mb-6">
                        <div className="text-4xl font-bold text-primary mb-2">
                          AED {property.predictedPrice?.toLocaleString() || 'N/A'}
                        </div>
                        <div className="text-gray-600">AI Predicted Annual Rent</div>
                      </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-gray-600">Certified Real Estate Agent</div>
